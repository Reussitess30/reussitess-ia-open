...
export default function BotVocal() {
  ...
  const boutiques: Boutique[] = [
    // Boutiques Personnelles (14)
    {
      ...
      langue: "en",
      description:
        "Boutique Amazon USA avec produits soigneusement sélectionnés",
    },
    {
      pays: "France",
      flag: "🇫🇷",
      ...
      langue: "fr",
      description: "Boutique Amazon France avec une sélection premium",
    },
    {
      pays: "Italie",
      flag: "🇮🇹",
      ...
      langue: "it",
      description: "Negozio Amazon Italia con prodotti selezionati",
    },
    {
      pays: "Espagne",
      flag: "🇪🇸",
      ...
      langue: "es",
      description: "Tienda Amazon España con productos cuidadosamente elegidos",
    },
    {
      pays: "Allemagne",
      flag: "🇩🇪",
      ...
      langue: "de",
      description: "Amazon Shop Deutschland mit ausgewählten Produkten",
    },
    {
      pays: "Canada",
      flag: "🇨🇦",
      ...
      langue: "en",
      description: "Amazon Canada store with curated products",
    },
    {
      pays: "Inde",
      flag: "🇮🇳",
      ...
      langue: "en",
      description: "Amazon India store with selected products",
    },
    {
      pays: "Pays-Bas",
      flag: "🇳🇱",
      ...
      langue: "nl",
      description: "Amazon Nederland winkel met geselecteerde producten",
    },
    {
      pays: "Suède",
      flag: "🇸🇪",
      ...
      langue: "sv",
      description: "Amazon Sverige butik med utvalda produkter",
    },
    {
      pays: "Singapour",
      flag: "🇸🇬",
      ...
      langue: "en",
      description: "Amazon Singapore store with curated products",
    },
    {
      pays: "Royaume-Uni",
      flag: "🇬🇧",
      ...
      langue: "en",
      description: "Amazon UK shop with premium selection",
    },
    {
      pays: "Australie",
      flag: "🇦🇺",
      ...
      langue: "en",
      description: "Amazon Australia store with selected products",
    },
    {
      pays: "Belgique",
      flag: "🇧🇪",
      ...
      langue: "fr",
      description: "Boutique Amazon Belgique avec sélection premium",
    },
    {
      pays: "Brésil",
      flag: "🇧🇷",
      ...
      langue: "pt",
      description: "Loja Amazon Brasil com produtos selecionados",
    },
    ...
    // Boutiques Influenceur (12)
    {
      ...
      langue: "en",
      description: "Amazon Australia influencer store",
    },
    {
      pays: "États-Unis",
      flag: "🇺🇸",
      ...
      langue: "en",
      description: "Amazon USA influencer store",
    },
    {
      pays: "Royaume-Uni",
      flag: "🇬🇧",
      ...
      langue: "en",
      description: "Amazon UK influencer shop",
    },
    {
      pays: "Inde",
      flag: "🇮🇳",
      ...
      langue: "en",
      description: "Amazon India influencer store",
    },
    {
      pays: "Suède",
      flag: "🇸🇪",
      ...
      langue: "sv",
      description: "Amazon Sverige influencer butik",
    },
    {
      pays: "Singapour",
      flag: "🇸🇬",
      ...
      langue: "en",
      description: "Amazon Singapore influencer store",
    },
    {
      pays: "Belgique",
      flag: "🇧🇪",
      ...
      langue: "fr",
      description: "Boutique Amazon Belgique influenceur",
    },
    {
      pays: "Espagne",
      flag: "🇪🇸",
      ...
      langue: "es",
      description: "Tienda Amazon España influencer",
    },
    {
      pays: "Allemagne",
      flag: "🇩🇪",
      ...
      langue: "de",
      description: "Amazon Deutschland Influencer Shop",
    },
    {
      pays: "Canada",
      flag: "🇨🇦",
      ...
      langue: "en",
      description: "Amazon Canada influencer store",
    },
    {
      pays: "Pays-Bas",
      flag: "🇳🇱",
      ...
      langue: "nl",
      description: "Amazon Nederland influencer winkel",
    },
    {
      pays: "Nouvelle-Zélande",
      flag: "🇳🇿",
      type: "Influenceur",
      lien: "https://www.amazon.co.nz/shop/influencer-fb942837",
      langue: "en",
      description: "Amazon New Zealand influencer store",
    },
  ];
  ...
  const handleUserInput = (input: string) => {
    ...
    if (lowerInput.match(/bonjour|salut|hello|hi|hola|ciao|guten tag/i)) {
      reply =
        "Bonjour ! Je suis votre assistant virtuel Reussitess Global Nexus. Je peux vous renseigner sur nos 26 boutiques Amazon dans 14 pays. Comment puis-je vous aider ?";
    }
    // Au revoir
    else if (lowerInput.match(/au revoir|bye|adios|ciao|tchao/i)) {
      reply =
        "Au revoir ! Merci de votre visite sur Reussitess Global Nexus. À bientôt !";
    }
    ...
    // Différence Personnel vs Influenceur
      ...
      reply =
        "Nous avons 2 types de boutiques : les boutiques Personnelles avec ma sélection premium de produits, et les boutiques Influenceur qui proposent des produits tendance. Les deux sont des boutiques Amazon officielles avec affiliation.";
    }
    // Comment ça marche
    else if (lowerInput.match(/comment|fonctionne|marche|works/i)) {
      reply =
        "C'est très simple ! Cliquez sur une boutique, faites vos achats normalement sur Amazon, et je reçois une petite commission. Cela ne change rien pour vous, les prix restent identiques !";
    }
    // Avantages
    else if (lowerInput.match(/avantage|pourquoi|why|benefit/i)) {
      reply =
        "En passant par nos boutiques, vous soutenez Reussitess sans frais supplémentaires ! Vous accédez aux mêmes produits Amazon aux mêmes prix, avec la garantie et le service Amazon.";
    }
    // Sécurité
    else if (lowerInput.match(/sécurisé|sûr|safe|secure/i)) {
      reply =
        "Absolument ! Tous nos liens sont des liens d'affiliation Amazon officiels et sécurisés. Vos achats sont 100% protégés par Amazon.";
    }
    // Aide générale
    else if (lowerInput.match(/aide|help|info|information/i)) {
      reply =
        "Je peux vous renseigner sur : le nombre de boutiques, les pays disponibles, comment ça fonctionne, la différence entre boutiques personnelles et influenceur, ou vous donner le lien d'une boutique spécifique. Que voulez-vous savoir ?";
    }
    // Lien vers boutique
    else if (lowerInput.match(/lien|link|visiter|visit/i)) {
      reply =
        "Bien sûr ! Quel pays vous intéresse ? France, États-Unis, Allemagne, Espagne, Italie, ou un autre ?";
    }
    // Réponse par défaut
    else {
      reply =
        "Je n'ai pas bien compris. Vous pouvez me demander : combien de boutiques nous avons, quels pays sont disponibles, comment ça fonctionne, ou me dire bonjour et au revoir !";
    }
          ...
          >
            <div>
              <h3 style={{ margin: 0, fontSize: "1.2rem" }}>
                🤖 Assistant Reussitess
              </h3>
              <p
                style={{ margin: "5px 0 0", fontSize: "0.9rem", opacity: 0.9 }}
              >
                {isListening
                  ? "🎤 J'écoute..."
                  : isSpeaking
          ...
          >
            ...
            {!transcript && !response && (
              ...
              >
                ...
                <p>
                  Bonjour ! Cliquez sur le micro ci-dessous et demandez-moi :
                </p>
                <ul
                  style={{
                    textAlign: "left",
