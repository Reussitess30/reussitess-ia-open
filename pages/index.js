...
export default function Home() {
  ...
  const quizCategories = [
    ...
    { id: "GoMining", name: "Bitcoin Mining", icon: "⛏", color: "#7c3aed" },
    ...
    { id: "Voyage", name: "Voyage", icon: "✈", color: "#3498db" },
    ...
    { id: "Droit", name: "Droit & Justice", icon: "⚖", color: "#455a64" },
    { id: "Architecture", name: "Architecture", icon: "🏗", color: "#795548" },
    ...
    { id: "Graphologie", name: "Graphologie — Votre Écriture Révèle", icon: "✍", color: "#4f46e5" },
    { id: "Spiritualite", name: "Spiritualité & Méditation Mondiale", icon: "🕊", color: "#0e7490" },
    ...
    { id: "IntelligenceEmotionnelle", name: "Intelligence Émotionnelle", icon: "❤", color: "#be185d" },
    { id: "Communication", name: "Communication & Art de Convaincre", icon: "🗣", color: "#0f766e" },
    ...
    { id: "EpicesMonde", name: "Épices du Monde — Saveurs & Secrets", icon: "🌶", color: "#dc2626" },
    ...
    { id: "DroitTravail", name: "Droit du Travail — Ce que Tout Salarié Doit Savoir", icon: "⚖", color: "#1e40af" },
    ...
    <Layout>
      <div style={{ minHeight: "70vh", background: "linear-gradient(135deg, #667eea 0%, #764ba2 50%, #f093fb 100%)", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", padding: "4rem 1rem" }}>
        <div style={{ textAlign: "center", color: "white", zIndex: 1, maxWidth: "1000px", margin: "0 auto" }}>
          <div style={{ marginBottom: "1rem" }}><img src="/icon-512x512.webp" alt="Reussitess®971" style={{ width: "120px", height: "120px", borderRadius: "20px", boxShadow: "0 10px 40px rgba(0,0,0,0.3)" }} /></div>
