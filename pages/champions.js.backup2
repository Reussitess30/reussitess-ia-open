...
export default function Champions() {
  ...
  const genererPhraseUnique = (pays, objectif) => {
    const phrases = phrasesInspirantesParObjectif[objectif] || phrasesInspirantesParObjectif.business
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                >
                  ...
                  {pays.map(p => (
                    <option key={p.code} value={p.code} style={{ background: '#1e293b' }}>
                      {p.emoji} {p.nom}
                    </option>
                  ))}
                </select>
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                >
                  ...
                  {objectifs.map(obj => (
                    <option key={obj.value} value={obj.value} style={{ background: '#1e293b' }}>
                      {obj.icon} {obj.label}
                    </option>
                  ))}
                </select>
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{
                ...
                <div>
                  <div style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Objectif</div>
                  <div style={{ fontSize: '1.3rem', fontWeight: '700', color: '#1e293b' }}>
                    {certificatData?.objectif?.icon} {certificatData?.objectif?.label}
                  </div>
                </div>
                <div>
                  <div style={{ color: '#94a3b8', fontSize: '0.9rem' }}>N° Passeport</div>
          ...
          {showBot && (
            <div style={{
              ...
              <p style={{ fontSize: '1.2rem', marginBottom: '1.5rem' }}>
                Notre Bot Assistant va maintenant créer votre plan sur 7 ou 30 jours<br/>
                basé sur votre objectif : <strong>{certificatData?.objectif?.label}</strong>
              </p>
              <button
                onClick={() => alert('Intégration BotAssistant en cours...')}
                style={{
                  padding: '1rem 2rem',
                  fontSize: '1.2rem',
                  fontWeight: '700',
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ color: '#94a3b8', fontSize: '1.1rem', marginTop: '0.5rem' }}>
                Pays représentés
              </div>
            </div>
          ...
          <p style={{
            ...
            Un mouvement d'excellence et de positivité<br/>
            qui inspire le monde entier depuis la Guadeloupe 🇬🇵<br/>
            <strong style={{ color: '#ffd700' }}>Excellence • Innovation • Succès</strong>
          </p>
        </div>
      </div>
