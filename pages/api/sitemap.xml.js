export default function handler(req, res) {
  ...
  const pages = [
    ...
    // 14 PAYS AMAZON
    { url: '/boutiques?pays=france', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=usa', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=canada', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=allemagne', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=espagne', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=italie', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=angleterre', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=australie', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=inde', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=bresil', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=singapour', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=suede', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=belgique', priority: '0.9', changefreq: 'weekly' },
    { url: '/boutiques?pays=pays-bas', priority: '0.9', changefreq: 'weekly' },
