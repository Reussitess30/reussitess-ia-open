const localData = {
  ...
  ia: "🤖 200 agents IA déployés : 1 Agent Suprême, 99 Nexus, 60 Neuro-X et 40 Sentinelles. Architecture hiérarchique pour gérer 14 pays simultanément !",
  staking: "💰 Stakez vos REUSS pour gagner 10 à 20% APR via le vecteur GAMMA-3 ! 1 REUSS staké = 1 vote dans la gouvernance de la plateforme.",
}

function getLocalResponse(message) {
  const msg = message.toLowerCase()
  if (msg.includes('guadeloupe') || msg.includes('971') || msg.includes('antill') || msg.includes('caraïb')) return localData.guadeloupe
  ...
  if (msg.includes('ia') || msg.includes('agent') || msg.includes('robot') || msg.includes('intelligence')) return localData.ia
  return null
}
