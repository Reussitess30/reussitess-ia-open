...
export default function Boutiques() {
  const translations = {
    ...
    "🇪🇸": { btn: "Visitar la Tienda", disclaimer: "Como affiliada, gano comisiones en ciertos productos" },
    "🇩🇪": { btn: "Shop Besuchen", disclaimer: "Als Partner verdiene ich an qualifizierten Käufen" },
    "🇳🇱": { btn: "Bezoek de Winkel", disclaimer: "Als partner verdien ik commissie op bepaalde produits" },
    "🇸🇪": { btn: "Besök Butiken", disclaimer: "Som partner tjänar jag provision på vissa produkter" },
    "🇨🇦": { btn: "Visit the Store", disclaimer: "As an affiliate, I earn commissions on certain products" },
    "🇧🇷": { btn: "Visite a Loja", disclaimer: "Como affiliada, ganho comissões em certos produtos" }
  }
  ...
  return (
    <Layout>
      <Head>
        <title>26 Boutiques Amazon - REUSSITESS® Global</title>
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="fr-FR" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="en-US" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="en-GB" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="en-CA" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="en-AU" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="en-NZ" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="en-IN" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="en-SG" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="it-IT" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="de-DE" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="es-ES" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="pt-BR" />
        <link rel="alternate" href="https://www.reussitess.fr/boutiques" hrefLang="sv-SE" />
      </Head>
            ...
            {boutiques.map((boutique, index) => (
              ...
              className="boutique-card">
                ...
                <div style={{
                  ...
                  🔒 {translations[boutique.flag]?.disclaimer || 'Commission sur certains achats'}
                </div>
              </div>
            ))}
          </div>
