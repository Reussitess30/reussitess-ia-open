          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: '1.5rem', color: '#3b82f6', marginBottom: '1rem', fontWeight: '700' }}>
                  Calculateurs Financiers
                </h3>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>📊</div>
                <h3 style={{ fontSize: '1.5rem', color: '#8b5cf6', marginBottom: '1rem', fontWeight: '700' }}>
                  Analyse de Marché
                </h3>
                <ul style={{ listStyle: 'none', padding: 0, color: '#475569', lineHeight: '2' }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🔧</div>
                <h3 style={{ fontSize: '1.5rem', color: '#10b981', marginBottom: '1rem', fontWeight: '700' }}>
                  Outils Techniques
                </h3>
                <ul style={{ listStyle: 'none', padding: 0, color: '#475569', lineHeight: '2' }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>📈</div>
                <h3 style={{ fontSize: '1.5rem', color: '#f59e0b', marginBottom: '1rem', fontWeight: '700' }}>
                  Suivi Performance
                </h3>
                <ul style={{ listStyle: 'none', padding: 0, color: '#475569', lineHeight: '2' }}>
