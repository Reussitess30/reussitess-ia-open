...
export default function PolitiqueConfidentialite() {
    ...
    return (<>
        <Head>
            ...
            <meta name="description" content="Politique de confidentialité et protection des données personnelles - Conforme RGPD" />
        </Head>
        <div style={{ padding: '50px', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <h1 style={{ color: '#667eea', marginBottom: '20px' }}>🔒 Politique de Confidentialité</h1>
            ...
            <div style={{ background: 'white', padding: '30px', borderRadius: '15px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)', lineHeight: '1.8' }}>
                ...
                <section style={{ marginTop: '30px' }}>
                    ...
                    <p>
                        REUSSITESS® Global Nexus s'engage à protéger la confidentialité de ses utilisateurs. 
                ...
                <section style={{ marginTop: '30px' }}>
                    ...
                    <p>
                        <strong>REUSSITESS® Global Nexus</strong><br />
                        Contact : via notre page de contact
                    </p>
                </section>

                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ color: '#667eea', marginBottom: '15px' }}>3. Données Collectées</h2>
                    ...
                    <ul style={{ marginLeft: '20px', marginTop: '10px' }}>
                        ...
                        <li><strong>Cookies :</strong> Pour améliorer l'expérience utilisateur et mesurer l'audience</li>
                        <li><strong>Données de contact :</strong> Si vous nous contactez volontairement (nom, email)</li>
                    </ul>
                </section>

                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ color: '#667eea', marginBottom: '15px' }}>4. Finalité du Traitement</h2>
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ color: '#667eea', marginBottom: '15px' }}>5. Partage des Données</h2>
                    <p>
                        Nous ne vendons pas vos données personnelles. Vos informations peuvent être partagées avec :
                    </p>
                    <ul style={{ marginLeft: '20px', marginTop: '10px' }}>
                        <li><strong>Amazon :</strong> Lorsque vous cliquez sur nos liens d'affiliation (conformément à leur politique de confidentialité)</li>
                        <li><strong>Hébergeur :</strong> Vercel (pour l'hébergement du site)</li>
                        <li><strong>Outils d'analyse :</strong> Pour les statistiques de trafic anonymisées</li>
                    </ul>
                </section>
                ...
                <section style={{ marginTop: '30px' }}>
                    ...
                    <p>
                        Notre site utilise des cookies pour améliorer votre expérience. Vous pouvez désactiver les cookies 
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ color: '#667eea', marginBottom: '15px' }}>8. Sécurité des Données</h2>
                    <p>
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ color: '#667eea', marginBottom: '15px' }}>9. Conservation des Données</h2>
                    <p>
                ...
                <section style={{ marginTop: '30px' }}>
                    ...
                    <p>
                        ...
                        responsables des pratiques de confidentialité de ces sites tiers. Nous vous encourageons à 
                ...
                <section style={{ marginTop: '30px' }}>
                    ...
                    <div style={{ padding: '20px', background: '#fef3c7', borderRadius: '10px', marginTop: '15px' }}>
                        <p>
                            <strong>⚠️ Déclaration d'Affiliation :</strong><br />
                            REUSSITESS® Global Nexus participe au Programme Partenaires d'Amazon, un programme 
                            d'affiliation conçu pour permettre aux sites de percevoir une rémunération par la 
                            création de liens vers Amazon.fr, Amazon.com et autres sites Amazon à travers le monde.
                            <br /><br />
                            Lorsque vous cliquez sur un lien d'affiliation Amazon et effectuez un achat, nous 
                            pouvons recevoir une commission sans frais supplémentaires pour vous. Ces commissions 
                            nous aident à maintenir et améliorer ce service gratuit.
                        </p>
                    </div>
                </section>
                ...
                <div style={{ marginTop: '40px', padding: '20px', background: '#e0e7ff', borderRadius: '10px' }}>
                    ...
                    <p>
                        ...
                        en France ou de l'autorité de protection des données de votre pays.
                    </p>
                </div>
            </div>
        </div>
