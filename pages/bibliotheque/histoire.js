...
export default function Histoire() {
    ...
    const figures = [
        { name: 'Toussaint Louverture', role: 'Leader de la révolution haïtienne', period: '1743-1803' },
        { name: 'Victor Schœlcher', role: 'Abolitionniste français', period: '1804-1893' },
        { name: 'Aimé Césaire', role: 'Poète, écrivain et homme politique martiniquais', period: '1913-2008' },
        { name: 'Léopold Sédar Senghor', role: 'Poète et premier président du Sénégal', period: '1906-2001' },
        { name: 'Frantz Fanon', role: 'Psychiatre et essayiste martiniquais', period: '1925-1961' },
        { name: 'Félix Éboué', role: 'Premier gouverneur noir de l\'Empire colonial français', period: '1884-1944' }
    ];

    return (<>
        <Head>
            <title>📖 Histoire Africaine & Outre-Mers - Bibliothèque Mondiale</title>
            <meta name="description" content="Histoire de l'Afrique, des Caraïbes, de la Martinique, Guadeloupe, Guyane et des anciennes colonies françaises" />
        </Head>

        <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)', padding: '20px' }}>
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                ...
                <div style={{ background: 'white', padding: '40px', borderRadius: '20px', boxShadow: '0 10px 40px rgba(0,0,0,0.2)' }}>
                    ...
                    <h1 style={{ fontSize: '3em', marginBottom: '10px', color: '#d97706' }}>
                        📖 Histoire Africaine & Outre-Mers
                    </h1>
                    <p style={{ fontSize: '1.2em', color: '#666', marginBottom: '40px' }}>
                        Chronologies, contextes culturels et biographies des territoires africains, caraïbes et ultra-marins
                    </p>
                    ...
                    {sections.map((section, i) => (
                        <div key={i} style={{ 
                            ...
                            <h2 style={{ color: '#d97706', marginBottom: '20px', fontSize: '1.8em' }}>
                                {section.title}
                            </h2>
                    ...
                    {/* Figures historiques */}
                    <h2 style={{ color: '#d97706', marginTop: '50px', marginBottom: '25px', fontSize: '2em' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
                        {figures.map((figure, i) => (
                            <div key={i} style={{ 
                                ...
                                <h3 style={{ color: '#d97706', marginBottom: '10px' }}>{figure.name}</h3>
                                <p style={{ fontSize: '0.95em', marginBottom: '5px' }}>{figure.role}</p>
                                <p style={{ fontSize: '0.9em', color: '#666', fontStyle: 'italic' }}>{figure.period}</p>
                            </div>
                        ))}
                    </div>
                    ...
                    <div style={{ 
                        ...
                        <h2 style={{ marginBottom: '20px', fontSize: '1.8em' }}>📚 Ressources Complémentaires</h2>
                        <p style={{ marginBottom: '15px', fontSize: '1.1em' }}>
                            Pour approfondir vos connaissances, consultez également :
                        </p>
                        <ul style={{ lineHeight: '2', fontSize: '1.05em' }}>
                            <li>Les fiches pays détaillées (Martinique, Guadeloupe, Guyane, France)</li>
                            <li>Les ressources pédagogiques pour professeurs</li>
                            <li>Les actualités internationales et évolutions culturelles</li>
                            <li>La section réglementation pour les aspects juridiques contemporains</li>
                        </ul>
                    </div>
