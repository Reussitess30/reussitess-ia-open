                ...
                <div style={{ background: 'white', padding: '40px', borderRadius: '20px', boxShadow: '0 10px 40px rgba(0,0,0,0.2)' }}>
                    ...
                    <div style={{ background: '#f9fafb', padding: '20px', borderRadius: '10px', marginBottom: '30px' }}>
                        <p style={{ marginBottom: '15px', fontSize: '1.05em', lineHeight: '1.6' }}>
                            <strong>PIB :</strong> ~10 milliards d'euros<br/>
                            <strong>Secteurs principaux :</strong> Services (tourisme), commerce, agriculture (banane, rhum)<br/>
                            <strong>Taux de chômage :</strong> ~16% (2024)<br/>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style={{ padding: '10px' }}>Majorité des produits et services</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style={{ padding: '10px', fontWeight: 'bold' }}>0-30%</td>
                                    <td style={{ padding: '10px' }}>Taxe locale sur importations</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div style={{ background: '#f9fafb', padding: '20px', borderRadius: '10px', marginBottom: '30px' }}>
                        <p style={{ marginBottom: '10px' }}><strong>Marketplace :</strong> Amazon.fr (livraison possible mais coûts élevés)</p>
                        <p style={{ marginBottom: '10px' }}><strong>Particularités :</strong></p>
                        <ul style={{ lineHeight: '1.8', paddingLeft: '20px' }}>
                            <li>Frais de livraison depuis métropole souvent élevés</li>
                            <li>Délais de livraison plus longs (7-15 jours généralement)</li>
                    ...
                    <div style={{ background: '#f9fafb', padding: '20px', borderRadius: '10px', marginBottom: '30px' }}>
                        <ul style={{ lineHeight: '2', fontSize: '1.05em' }}>
                            <li><strong>1502 :</strong> Découverte par Christophe Colomb</li>
                            <li><strong>1635 :</strong> Colonisation française (Belain d'Esnambuc)</li>
                            <li><strong>XVIIe-XIXe :</strong> Économie sucrière et esclavage</li>
                            <li><strong>1848 :</strong> Abolition de l'esclavage (Victor Schœlcher)</li>
                            <li><strong>1902 :</strong> Éruption de la Montagne Pelée détruisant Saint-Pierre</li>
                    ...
                    <div style={{ background: '#f9fafb', padding: '20px', borderRadius: '10px', marginBottom: '30px' }}>
                        ...
                        <ul style={{ lineHeight: '1.8', paddingLeft: '20px' }}>
                            ...
                            <li>Fort-de-France : Bibliothèque Schœlcher, Fort Saint-Louis</li>
                    ...
                    <div style={{ background: '#f9fafb', padding: '20px', borderRadius: '10px' }}>
                        <p style={{ marginBottom: '10px' }}>📄 Collectivité Territoriale de Martinique</p>
