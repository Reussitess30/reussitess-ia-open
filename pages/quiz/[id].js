...
export default function QuizPage() {
  ...
  if (showResults) {
    ...
    return (
      <Layout>
        <Head>
          <title>{quiz.title} - Résultats | REUSSITESS®</title>
        </Head>
        <div style={{
          minHeight: '100vh',
          background: 'linear-gradient(180deg, #0f172a 0%, #1e293b 100%)',
            ...
            <div style={{
              ...
              <div style={{
                ...
                {percentage >= 80 ? '🌟 Excellent ! Vous maîtrisez ce sujet !' :
                 percentage >= 60 ? '👏 Bon travail ! Continuez à vous améliorer.' :
  ...
  return (
    <Layout>
      <Head>
        <title>{quiz.title} | Quiz REUSSITESS®</title>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: selectedAnswer === index 
                      ? (index === question.correct ? 'rgba(16, 185, 129, 0.2)' : 'rgba(239, 68, 68, 0.2)')
                      : 'rgba(255, 255, 255, 0.03)',
                    border: selectedAnswer === index
                      ? (index === question.correct ? '2px solid #10b981' : '2px solid #ef4444')
          ...
          {showExplanation && (
            <div style={{ textAlign: 'center' }}>
              <button
                ...
                className="btn-next">
                {currentQuestion + 1 < quiz.questions.length ? 'Question Suivante →' : 'Voir les Résultats 🏆'}
              </button>
            </div>
          )}
        </div>
