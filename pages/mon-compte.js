...
export default function MonCompte() {
  ...
  const rewards = [
    { reuss: 1000, label: "5% réduction boutique Amazon", icon: "🛍️", available: reussPoints >= 1000 },
    ...
    { reuss: 50000, label: "Tier Silver — Cashback 8%", icon: "🥈", available: reussPoints >= 50000 },
    { reuss: 100000, label: "Tier Gold — Cashback 15%", icon: "🥇", available: reussPoints >= 100000 },
    { reuss: 500000, label: "Tier Platinum — Cashback 20% + Gouvernance", icon: "💎", available: reussPoints >= 500000 },
  ];
