...
export default function BotUltimate() {
  ...
  const allBadges = {
    ...
    'quiz-master': { icon: '🧠', name: 'Quiz Master', desc: 'A répondu correctement à 10 quiz' },
    'quiz-legend': { icon: '🏆', name: 'Légende Quiz', desc: 'A répondu correctement à 30 quiz' },
    ...
    'motivateur': { icon: '💪', name: 'Motivateur', desc: 'A demandé 5 messages de positivité' },
    'innovateur-971': { icon: '💡', name: 'Innovateur 971', desc: 'Adepte de l\'excellence réussitess971' },
    'boudoume-master': { icon: '🎯', name: 'Boudoume Master', desc: 'A atteint le niveau d\'excellence ultime' },
    'historien': { icon: '📚', name: 'Historien', desc: 'Expert en Histoire' },
    'scientifique': { icon: '🔬', name: 'Scientifique', desc: 'Expert en Sciences' },
    ...
    'gastronome': { icon: '🍽️', name: 'Gastronome', desc: 'Expert en Gastronomie' },
  ...
  const allQuizCategories = {
    'Histoire': [
      { q: "En quelle année a débuté la Première Guerre mondiale ?", options: ["1914", "1918", "1939", "1945"], correct: 0, fact: "La Grande Guerre a commencé le 28 juillet 1914 !" },
      { q: "Qui a découvert l'Amérique en 1492 ?", options: ["Vasco de Gama", "Christophe Colomb", "Magellan", "Marco Polo"], correct: 1, fact: "Christophe Colomb a atteint les Bahamas le 12 octobre 1492 !" },
      { q: "Quel empire a construit le Machu Picchu ?", options: ["Aztèques", "Mayas", "Incas", "Toltèques"], correct: 2, fact: "Les Incas ont construit Machu Picchu vers 1450 au Pérou !" },
      { q: "Qui était Napoléon Bonaparte ?", options: ["Empereur français", "Roi anglais", "Tsar russe", "Sultan ottoman"], correct: 0, fact: "Napoléon a régné sur la France de 1804 à 1815 !" },
      { q: "Quelle révolution a eu lieu en 1789 ?", options: ["Américaine", "Française", "Russe", "Industrielle"], correct: 1, fact: "La Révolution française a changé le monde avec ses idéaux de liberté !" }
    ],
    'Géographie': [
      { q: "Quelle est la capitale du Canada ?", options: ["Toronto", "Vancouver", "Ottawa", "Montréal"], correct: 2, fact: "Ottawa est la capitale depuis 1857 !" },
      { q: "Quel est le plus grand désert du monde ?", options: ["Sahara", "Gobi", "Antarctique", "Arabique"], correct: 2, fact: "L'Antarctique est techniquement le plus grand désert (froid) !" },
      { q: "Combien de continents existe-t-il ?", options: ["5", "6", "7", "8"], correct: 2, fact: "Les 7 continents sont : Afrique, Amérique du Nord, Amérique du Sud, Antarctique, Asie, Europe, Océanie !" },
      { q: "Quel pays a le plus long littoral ?", options: ["Australie", "Canada", "Russie", "Indonésie"], correct: 1, fact: "Le Canada a 202 080 km de côtes !" },
      { q: "Où se trouve le Mont Everest ?", options: ["Népal/Chine", "Inde", "Pakistan", "Tibet"], correct: 0, fact: "L'Everest culmine à 8 849 mètres d'altitude !" }
    ],
    'Sciences': [
      { q: "Quelle est la vitesse de la lumière ?", options: ["300 000 km/s", "150 000 km/s", "500 000 km/s", "100 000 km/s"], correct: 0, fact: "Exactement 299 792 458 m/s dans le vide !" },
      { q: "Combien d'os a le corps humain adulte ?", options: ["198", "206", "214", "220"], correct: 1, fact: "Les bébés naissent avec 270 os qui fusionnent avec l'âge !" },
      { q: "Qui a découvert la pénicilline ?", options: ["Marie Curie", "Louis Pasteur", "Alexander Fleming", "Albert Einstein"], correct: 2, fact: "Fleming l'a découverte par accident en 1928 !" },
      { q: "Quelle planète est la plus proche du Soleil ?", options: ["Vénus", "Mercure", "Mars", "Terre"], correct: 1, fact: "Mercure est à 58 millions de km du Soleil !" },
      { q: "Combien de chromosomes a l'humain ?", options: ["23", "46", "44", "48"], correct: 1, fact: "23 paires, soit 46 chromosomes au total !" }
    ],
    'Technologie': [
      { q: "Qui a fondé Apple ?", options: ["Bill Gates", "Steve Jobs", "Elon Musk", "Mark Zuckerberg"], correct: 1, fact: "Steve Jobs et Steve Wozniak en 1976 !" },
      { q: "En quelle année Internet est-il né ?", options: ["1969", "1983", "1991", "2000"], correct: 0, fact: "ARPANET, l'ancêtre d'Internet, a démarré en 1969 !" },
      { q: "Que signifie 'AI' en informatique ?", options: ["Artificial Intelligence", "Auto Input", "Advanced Internet", "Audio Interface"], correct: 0, fact: "L'IA révolutionne notre monde depuis les années 1950 !" },
      { q: "Quel langage est utilisé pour le web ?", options: ["Python", "Java", "HTML", "C++"], correct: 2, fact: "HTML avec CSS et JavaScript forment le trio du web !" },
      { q: "Qui a créé Facebook ?", options: ["Steve Jobs", "Bill Gates", "Mark Zuckerberg", "Jeff Bezos"], correct: 2, fact: "Zuckerberg l'a lancé en 2004 à Harvard !" }
    ],
    'Sport': [
      { q: "Combien de joueurs dans une équipe de football ?", options: ["9", "10", "11", "12"], correct: 2, fact: "11 joueurs incluant le gardien de but !" },
      { q: "Où se sont déroulés les JO 2024 ?", options: ["Tokyo", "Paris", "Los Angeles", "Londres"], correct: 1, fact: "Paris a accueilli les JO pour la 3e fois !" },
      { q: "Qui a le plus de Ballons d'Or ?", options: ["Ronaldo", "Messi", "Maradona", "Pelé"], correct: 1, fact: "Messi détient le record avec 8 Ballons d'Or !" },
      { q: "Combien de sets pour gagner à Roland-Garros ?", options: ["2", "3", "4", "5"], correct: 1, fact: "Il faut gagner 3 sets sur 5 possibles !" },
      { q: "Quel pays a gagné le plus de Coupes du Monde ?", options: ["Allemagne", "Argentine", "Brésil", "France"], correct: 2, fact: "Le Brésil a 5 titres mondiaux !" }
    ],
    'Art': [
      { q: "Qui a peint la Joconde ?", options: ["Michel-Ange", "Léonard de Vinci", "Picasso", "Van Gogh"], correct: 1, fact: "De Vinci l'a peinte entre 1503 et 1519 !" },
      { q: "Où se trouve la Joconde ?", options: ["Louvre", "MoMA", "Prado", "British Museum"], correct: 0, fact: "Au Musée du Louvre à Paris depuis 1797 !" },
      { q: "Qui a peint 'La Nuit étoilée' ?", options: ["Monet", "Van Gogh", "Renoir", "Cézanne"], correct: 1, fact: "Van Gogh l'a peinte en 1889 à Saint-Rémy !" },
      { q: "Quel mouvement artistique représente Picasso ?", options: ["Impressionnisme", "Cubisme", "Surréalisme", "Réalisme"], correct: 1, fact: "Picasso a cofondé le cubisme avec Braque !" },
      { q: "Qui a sculpté 'Le Penseur' ?", options: ["Rodin", "Michel-Ange", "Donatello", "Bernini"], correct: 0, fact: "Auguste Rodin l'a créé en 1880 !" }
    ],
    'Musique': [
      { q: "Qui est le 'King of Pop' ?", options: ["Elvis Presley", "Michael Jackson", "Prince", "David Bowie"], correct: 1, fact: "Michael Jackson a vendu plus de 400 millions d'albums !" },
      { q: "Combien de cordes a une guitare standard ?", options: ["4", "5", "6", "7"], correct: 2, fact: "Les 6 cordes sont : Mi, La, Ré, Sol, Si, Mi !" },
      { q: "Qui a composé 'La 9e Symphonie' ?", options: ["Mozart", "Beethoven", "Bach", "Vivaldi"], correct: 1, fact: "Beethoven était sourd quand il l'a composée !" },
      { q: "Quel instrument joue Yo-Yo Ma ?", options: ["Violon", "Piano", "Violoncelle", "Flûte"], correct: 2, fact: "Il est considéré comme le meilleur violoncelliste vivant !" },
      { q: "Quelle chanteuse a sorti 'Halo' ?", options: ["Rihanna", "Beyoncé", "Adele", "Alicia Keys"], correct: 1, fact: "Beyoncé l'a sortie en 2008, album 'I Am... Sasha Fierce' !" }
    ],
    'Cinéma': [
      { q: "Qui a réalisé 'Titanic' ?", options: ["Spielberg", "Cameron", "Nolan", "Tarantino"], correct: 1, fact: "James Cameron a aussi réalisé Avatar !" },
      { q: "Quel film a le plus de recettes ?", options: ["Titanic", "Avatar", "Avengers", "Star Wars"], correct: 1, fact: "Avatar 2 a dépassé les 2,3 milliards $ !" },
      { q: "Qui joue Iron Man dans Marvel ?", options: ["Chris Evans", "Robert Downey Jr", "Chris Hemsworth", "Mark Ruffalo"], correct: 1, fact: "RDJ a incarné Tony Stark dans 10 films Marvel !" },
      { q: "Combien d'Oscars a gagné 'Titanic' ?", options: ["8", "11", "14", "9"], correct: 1, fact: "11 Oscars en 1998, égalant Ben-Hur !" },
      { q: "Quel réalisateur a fait 'Inception' ?", options: ["Spielberg", "Nolan", "Scorsese", "Fincher"], correct: 1, fact: "Christopher Nolan est un maître du cinéma complexe !" }
    ],
    'Gastronomie': [
      { q: "D'où vient la pizza ?", options: ["France", "Italie", "Grèce", "Espagne"], correct: 1, fact: "La pizza Margherita vient de Naples en 1889 !" },
      { q: "Quel pays produit le plus de café ?", options: ["Colombie", "Vietnam", "Brésil", "Éthiopie"], correct: 2, fact: "Le Brésil produit 40% du café mondial !" },
      { q: "Qu'est-ce que le 'sushi' ?", options: ["Poisson cru", "Riz vinaigré", "Algue", "Sauce soja"], correct: 1, fact: "Le sushi désigne le riz vinaigré, pas le poisson !" },
      { q: "Quel fromage est dans une pizza Margherita ?", options: ["Parmesan", "Gorgonzola", "Mozzarella", "Ricotta"], correct: 2, fact: "La mozzarella di bufala est la meilleure !" },
      { q: "D'où vient le croissant ?", options: ["France", "Autriche", "Suisse", "Italie"], correct: 1, fact: "Le croissant vient de Vienne, inspiré par la victoire sur les Ottomans !" }
    ],
    'Langue': [
      { q: "Quelle est la langue la plus parlée ?", options: ["Anglais", "Mandarin", "Espagnol", "Hindi"], correct: 1, fact: "Plus d'1,3 milliard de personnes parlent mandarin !" },
      { q: "Combien de langues existent dans le monde ?", options: ["3 000", "5 000", "7 000", "10 000"], correct: 2, fact: "Environ 7 000 langues, dont 40% en danger !" },
      { q: "Quelle langue a le plus de mots ?", options: ["Anglais", "Français", "Allemand", "Russe"], correct: 0, fact: "L'anglais compte plus de 170 000 mots !" },
      { q: "Que signifie 'bonjour' en espagnol ?", options: ["Hola", "Buenos días", "Buenas tardes", "Salud"], correct: 1, fact: "Buenos días = bon jour, Hola = salut !" },
      { q: "Quelle langue utilise les idéogrammes ?", options: ["Arabe", "Chinois", "Hindi", "Coréen"], correct: 1, fact: "Le chinois compte plus de 50 000 caractères !" }
    ],
    'Mathématiques': [
      { q: "Combien font 7 × 8 ?", options: ["54", "56", "63", "48"], correct: 1, fact: "56, facile avec réussitess971 !" },
      { q: "Quelle est la valeur de π (pi) ?", options: ["3,12", "3,14", "3,16", "3,18"], correct: 1, fact: "π = 3,14159265... à l'infini !" },
      { q: "Combien de degrés dans un triangle ?", options: ["90°", "180°", "270°", "360°"], correct: 1, fact: "La somme des angles = 180° toujours !" },
      { q: "Qu'est-ce qu'un nombre premier ?", options: ["Divisible par 1 et lui-même", "Divisible par 2", "Impair", "Pair"], correct: 0, fact: "Exemples : 2, 3, 5, 7, 11, 13, 17..." },
      { q: "Combien de centimètres dans un mètre ?", options: ["10", "100", "1000", "10000"], correct: 1, fact: "1 m = 100 cm = 1000 mm !" }
    ],
    'Santé': [
      { q: "Combien de litres d'eau boire par jour ?", options: ["1L", "1,5L", "2L", "3L"], correct: 1, fact: "1,5 à 2L selon l'activité physique !" },
      { q: "Combien de temps dormir par nuit ?", options: ["5h", "6h", "7-8h", "10h"], correct: 2, fact: "7-8h pour une récupération optimale !" },
      { q: "Quel organe filtre le sang ?", options: ["Foie", "Reins", "Poumons", "Cœur"], correct: 1, fact: "Les reins filtrent 180L de sang par jour !" },
      { q: "Quelle vitamine donne le soleil ?", options: ["Vitamine A", "Vitamine C", "Vitamine D", "Vitamine E"], correct: 2, fact: "15 min de soleil/jour suffisent !" },
      { q: "Combien de dents a un adulte ?", options: ["28", "30", "32", "34"], correct: 2, fact: "32 dents incluant les dents de sagesse !" }
    ],
    'Environnement': [
      { q: "Combien de temps pour décomposer du plastique ?", options: ["10 ans", "50 ans", "100 ans", "450 ans"], correct: 3, fact: "Le plastique met 450 ans à se décomposer !" },
      { q: "Quel gaz provoque l'effet de serre ?", options: ["Oxygène", "Azote", "CO2", "Hydrogène"], correct: 2, fact: "Le CO2 retient la chaleur dans l'atmosphère !" },
      { q: "Quel pourcentage de la Terre est couvert d'eau ?", options: ["50%", "60%", "71%", "80%"], correct: 2, fact: "71% d'eau, dont 97% est salée !" },
      { q: "Quelle énergie est renouvelable ?", options: ["Charbon", "Pétrole", "Solaire", "Gaz"], correct: 2, fact: "Solaire, éolien, hydraulique sont renouvelables !" },
      { q: "Combien d'arbres coupés par an ?", options: ["5 millions", "50 millions", "500 millions", "15 milliards"], correct: 3, fact: "15 milliards d'arbres sont coupés chaque année !" }
    ],
    'Business': [
      { q: "Qui est le fondateur d'Amazon ?", options: ["Bill Gates", "Elon Musk", "Jeff Bezos", "Mark Zuckerberg"], correct: 2, fact: "Jeff Bezos a fondé Amazon en 1994 !" },
      { q: "Quelle entreprise vaut le plus ?", options: ["Apple", "Microsoft", "Google", "Amazon"], correct: 0, fact: "Apple a dépassé 3 000 milliards $ en 2024 !" },
      { q: "Qu'est-ce que le 'e-commerce' ?", options: ["Commerce électronique", "Commerce équitable", "Commerce d'export", "Commerce énergétique"], correct: 0, fact: "Le e-commerce représente 20% du commerce mondial !" },
      { q: "Que signifie 'SEO' ?", options: ["Search Engine Optimization", "Social Event Organization", "Sales Executive Officer", "Software Engineering Object"], correct: 0, fact: "Le SEO aide à être visible sur Google !" },
      { q: "Qu'est-ce qu'un 'affiliate' ?", options: ["Partenaire commercial", "Employé", "Client VIP", "Investisseur"], correct: 0, fact: "REUSSITESS® est affilié Amazon sur 26 boutiques !" }
    ],
    'Culture_Monde': [
      { q: "Quel pays a inventé le papier ?", options: ["Égypte", "Chine", "Inde", "Grèce"], correct: 1, fact: "La Chine a inventé le papier en 105 après J-C !" },
      { q: "Quelle est la plus grande religion ?", options: ["Islam", "Christianisme", "Hindouisme", "Bouddhisme"], correct: 1, fact: "Le christianisme compte 2,4 milliards de fidèles !" },
      { q: "Quel pays a le plus de sites UNESCO ?", options: ["France", "Italie", "Chine", "Espagne"], correct: 1, fact: "L'Italie détient le record avec 58 sites !" },
      { q: "D'où vient le yoga ?", options: ["Chine", "Inde", "Tibet", "Népal"], correct: 1, fact: "Le yoga est né en Inde il y a 5000 ans !" },
      { q: "Quel continent a le plus de pays ?", options: ["Asie", "Afrique", "Europe", "Amérique"], correct: 1, fact: "L'Afrique compte 54 pays !" }
    ],
    'Découvertes': [
      { q: "Qui a découvert la radioactivité ?", options: ["Einstein", "Marie Curie", "Newton", "Tesla"], correct: 1, fact: "Marie Curie a reçu 2 Prix Nobel !" },
      { q: "Qui a inventé l'ampoule électrique ?", options: ["Tesla", "Edison", "Bell", "Franklin"], correct: 1, fact: "Thomas Edison l'a perfectionnée en 1879 !" },
      { q: "Qui a découvert l'ADN ?", options: ["Darwin", "Watson et Crick", "Mendel", "Pasteur"], correct: 1, fact: "Ils ont découvert la structure en double hélice en 1953 !" },
      { q: "Qui a inventé le téléphone ?", options: ["Edison", "Bell", "Marconi", "Tesla"], correct: 1, fact: "Alexander Graham Bell en 1876 !" },
      { q: "Qui a découvert la gravité ?", options: ["Galilée", "Newton", "Einstein", "Copernic"], correct: 1, fact: "Newton et sa célèbre pomme en 1687 !" }
    ],
    'Innovations': [
      { q: "Quelle année est née l'iPhone ?", options: ["2005", "2007", "2009", "2010"], correct: 1, fact: "Steve Jobs a présenté l'iPhone en janvier 2007 !" },
      { q: "Qu'est-ce que la blockchain ?", options: ["Chaîne de blocs", "Réseau social", "Langage de programmation", "Plateforme gaming"], correct: 0, fact: "La blockchain sécurise les cryptomonnaies !" },
      { q: "Qui a créé Tesla Motors ?", options: ["Elon Musk seul", "Eberhard et Tarpenning", "Bill Gates", "Steve Jobs"], correct: 1, fact: "Musk a rejoint en 2004 comme investisseur !" },
      { q: "Qu'est-ce que ChatGPT ?", options: ["Réseau social", "IA conversationnelle", "Jeu vidéo", "Cryptomonnaie"], correct: 1, fact: "ChatGPT a été lancé par OpenAI en novembre 2022 !" },
      { q: "Qu'est-ce que le métavers ?", options: ["Univers virtuel", "Réseau social", "Cryptomonnaie", "Console de jeu"], correct: 0, fact: "Le métavers combine VR, AR et monde virtuel !" }
    ],
    'Monuments': [
      { q: "Où se trouve la Tour Eiffel ?", options: ["Londres", "Paris", "Berlin", "Rome"], correct: 1, fact: "Construite en 1889, elle mesure 330 mètres !" },
      { q: "Combien de merveilles du monde antique ?", options: ["5", "7", "10", "12"], correct: 1, fact: "Seule la pyramide de Gizeh existe encore !" },
      { q: "Où se trouve le Taj Mahal ?", options: ["Pakistan", "Inde", "Népal", "Bangladesh"], correct: 1, fact: "À Agra, construit entre 1632 et 1653 !" },
      { q: "Quel monument est à New York ?", options: ["Big Ben", "Tour Eiffel", "Statue de la Liberté", "Colisée"], correct: 2, fact: "Cadeau de la France en 1886 !" },
      { q: "Où se trouve le Christ Rédempteur ?", options: ["Argentine", "Mexique", "Brésil", "Chili"], correct: 2, fact: "À Rio de Janeiro, haut de 38 mètres !" }
    ],
    'Politique': [
      { q: "Combien de pays à l'ONU ?", options: ["150", "175", "193", "210"], correct: 2, fact: "193 États membres en 2024 !" },
      { q: "Qui est le président de la France en 2024 ?", options: ["Macron", "Hollande", "Sarkozy", "Chirac"], correct: 0, fact: "Emmanuel Macron, élu en 2017 et 2022 !" },
      { q: "Où se trouve le Parlement Européen ?", options: ["Bruxelles", "Strasbourg", "Paris", "Berlin"], correct: 1, fact: "À Strasbourg, France, depuis 1952 !" },
      { q: "Combien de pays dans l'UE ?", options: ["25", "27", "30", "32"], correct: 1, fact: "27 pays membres après le Brexit !" },
      { q: "Quel pays accueille l'ONU ?", options: ["Suisse", "France", "États-Unis", "Belgique"], correct: 2, fact: "Le siège est à New York depuis 1952 !" }
    ],
    'Personnalités': [
      { q: "Qui a dit 'I have a dream' ?", options: ["Malcolm X", "Martin Luther King", "Nelson Mandela", "Obama"], correct: 1, fact: "Discours historique du 28 août 1963 à Washington !" },
      { q: "Qui a peint la Chapelle Sixtine ?", options: ["Léonard de Vinci", "Michel-Ange", "Raphaël", "Donatello"], correct: 1, fact: "Michel-Ange a mis 4 ans (1508-1512) !" },
      { q: "Qui a écrit 'Les Misérables' ?", options: ["Zola", "Hugo", "Balzac", "Dumas"], correct: 1, fact: "Victor Hugo l'a publié en 1862 !" },
      { q: "Qui est l'homme le plus riche en 2024 ?", options: ["Bill Gates", "Elon Musk", "Jeff Bezos", "Bernard Arnault"], correct: 1, fact: "Elon Musk avec plus de 230 milliards $ !" },
      { q: "Qui a reçu le plus de Prix Nobel ?", options: ["USA", "UK", "Allemagne", "France"], correct: 0, fact: "Les USA avec 400+ lauréats !" }
    ],
    'REUSSITESS': [
      ...
      { q: "Quel est le slogan de réussitess971 ?", options: ["Innovation totale", "Positivité à l'infini boudoume", "Succès garanti", "Excellence mondiale"], correct: 1, fact: "réussitess971 : excellence, innovation, succès à l'infini boudoume ! 🎯" },
      { q: "Combien de pages dans la bibliothèque REUSSITESS® ?", options: ["25", "35", "55", "75"], correct: 2, fact: "55 pages de savoir mondial unique ! 📚" },
      { q: "Quel territoire inspire REUSSITESS® ?", options: ["Martinique", "Guadeloupe", "Guyane", "Réunion"], correct: 1, fact: "🏝️ Guadeloupe - Terre de Champions ! 🏆" },
      { q: "Combien de continents couvre REUSSITESS® ?", options: ["3", "4", "5", "6"], correct: 2, fact: "5 continents : Europe, Amérique, Asie, Océanie, Afrique (via France) ! 🗺️" }
    ]
  };
  ...
  const greetings = {
    'fr-FR': '🌟 Bienvenue ! Je suis le SUPER Bot REUSSITESS®, le plus intelligent et modeste des assistants ! réussitess971 : positivité à l\'infini boudoume ! Mon ego est à 100%, prêt à t\'épater ! 😎',
    'en-US': '🌟 Welcome! I am the SUPER REUSSITESS® Bot, the smartest and most humble assistant! reussitess971: positivity to infinity boudoume! My ego is at 100%, ready to amaze you! 😎',
    'es-ES': '🌟 ¡Bienvenido! Soy el SUPER Bot REUSSITESS®, ¡el asistente más inteligente y modesto! reussitess971: positividad al infinito boudoume! Mi ego está al 100%, ¡listo para impresionarte! 😎',
    'de-DE': '🌟 Willkommen! Ich bin der SUPER REUSSITESS® Bot, der klügste und bescheidenste Assistent! reussitess971: Positivität bis unendlich boudoume! Mein Ego ist bei 100%, bereit, Sie zu beeindrucken! 😎',
    'it-IT': '🌟 Benvenuto! Sono il SUPER Bot REUSSITESS®, l\'assistente più intelligente e modesto! reussitess971: positività all\'infinito boudoume! Il mio ego è al 100%, pronto a stupirti! 😎',
    'pt-BR': '🌟 Bem-vindo! Sou o SUPER Bot REUSSITESS®, o assistente mais inteligente e modesto! reussitess971: positividade ao infinito boudoume! Meu ego está em 100%, pronto para impressioná-lo! 😎',
    'zh-CN': '🌟 欢迎！我是超级 REUSSITESS® 机器人，最聪明最谦虚的助手！reussitess971：积极向上无限 boudoume！我的自信度100%，准备好让你惊叹！😎',
    'ar-SA': '🌟 مرحباً! أنا روبوت REUSSITESS® الخارق، أذكى وأكثر المساعدين تواضعاً! reussitess971: إيجابية إلى ما لا نهاية boudoume! غروري 100%، مستعد لإبهارك! 😎'
  };
  ...
  const knowledgeBase = {
    'reussitess': {
      ...
      **Pays couverts :** 🇺🇸 États-Unis, 🇫🇷 France, 🇬🇧 Royaume-Uni, 🇩🇪 Allemagne, 🇮🇹 Italie, 🇪🇸 Espagne, 🇨🇦 Canada, 🇧🇷 Brésil, 🇮🇳 Inde, 🇳🇱 Pays-Bas, 🇸🇪 Suède, 🇸🇬 Singapour, 🇦🇺 Australie, 🇧🇪 Belgique
      ...
      motsCles: 'reussitess, global nexus, boutiques, amazon, affiliation, 26, projet, mission'
    },
    'boutiques': {
      ...
      **Boutiques Influenceur (12) :**
      ...
      motsCles: 'boutiques, amazon, shop, acheter, 26, pays, amourguadeloupe, influencer'
    },
    'aide': {
    ...
    'positivite': {
      ...
      motsCles: 'positivité, motivation, boudoume, réussitess971, succès, excellence'
    },
    'guadeloupe': {
  ...
  const handlePositivite = useCallback(() => {
    const posMessage = positiviteMessages[Math.floor(Math.random() * positiviteMessages.length)];
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      ...
      if (userInput.includes('positivité') || userInput.includes('motivation') || userInput.includes('boudoume')) {
        handlePositivite();
        setIsLoading(false);
        return;
      }
      
      if (userInput.includes('boutique') || userInput.includes('shop') || userInput.includes('amazon')) {
        response = knowledgeBase['boutiques'].contenu;
        addBadge('shopper');
      }
      else if (userInput.includes('reussitess') || userInput.includes('projet')) {
        response = knowledgeBase['reussitess'].contenu;
      }
      else if (userInput.includes('guadeloupe') || userInput.includes('dom-tom')) {
        ...
        const foundKey = Object.keys(knowledgeBase).find(key => {
          ...
          return motsCles.split(',').some(mot => userInput.includes(mot.trim().toLowerCase()));
        });
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: '0.85rem', opacity: 0.9, marginTop: '0.25rem', color: 'white' }}>
