...
function renderBotMessage(text) {
  return text
    ...
    .replace(/\[([^\]]+)\]\((https?:\/\/[^)]+)\)/g, '<a href="$2" target="_blank" rel="noopener noreferrer nofollow" onclick="window.open(this.href,\'_blank\');return false;" style="color:#10b981;text-decoration:underline;">$1</a>')
