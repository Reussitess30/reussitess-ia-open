...
export function TranslationProvider({ children }) {
  ...
  const translations = {
    fr: {
      home: "Accueil",
      boutiques: "Boutiques",
      welcome: "Bienvenue sur REUSSITESS® REUSSITESS®NEURO-X",
      start: "Commencer",
    ...
    en: {
      home: "Home",
      boutiques: "Stores",
      welcome: "Welcome to REUSSITESS® REUSSITESS®NEURO-X",
      start: "Get Started",
    ...
    es: {
      home: "Inicio",
      boutiques: "Tiendas",
      welcome: "Bienvenido a REUSSITESS® REUSSITESS®NEURO-X",
      start: "Comenzar",
    ...
    de: {
      home: "Startseite",
      boutiques: "Geschäfte",
      welcome: "Willkommen bei REUSSITESS® REUSSITESS®NEURO-X",
      start: "Starten",
